...
conn = mysql.connector.connect(host="127.0.0.1",user="mostafa",password="0114.80.455.41Mm",database="teach_me")
cursor = conn.cursor()
...
def backup():
    ...
    dumpcmd = "mysqldump -h " + DB_HOST + " -u " + DB_USER + " -y -p" + DB_USER_PASSWORD + " " + db + " > " + command[0] + "/" + db + ".sql"
    os.system(dumpcmd)
